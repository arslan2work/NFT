            ...
            <div>
                ...
                <div className="nft-detail-adj">
                    <div>
                        <div>
                            <div className="">
                                <img alt="main" style={{ height: '400px', marginLeft: '400px'}} className=" shadow-lg rounded" src={localStorage.getItem(this.state.imageData_name[key])} />
                            </div>
                        </div>

                        <div>
                            <div className="table-adj mt-5">
